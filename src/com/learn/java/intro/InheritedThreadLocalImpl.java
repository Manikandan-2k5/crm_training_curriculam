...
public class InheritedThreadLocalImpl {
	...
	public static void main(String[] args) {
		...
		/**
		 *Thread 1 and Thread 2 Context setting using Inhertable Thread Local.
		 */
	...
	/**
	 * <p>This method creates 2 threads which sets inheritable thread local value and manipulates it.</p>
	 */
